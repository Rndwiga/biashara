        ...
        <div class="col-sm-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    {!! Form::open(['route' => 'biashara.item.store', 'method' => 'post', 'files' => true ]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <span class="desc"></span>
                        {{ Form::textarea('item_description', null, ['class' => 'form-control', 'id' => 'postBody']) }}
                    ...
                    <div class="form-group">
                        ...
                        <span class="desc"></span>
                        <div class="controls">
                            {{ Form::text('item_summary', null, ['class' => 'form-control']) }}
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <span class="desc"></span>
                        {{Form::select('item_type', ['machinery' => 'Machinery', 'supplies' => 'Supplied'], null, ['placeholder' => 'Select Item Type', 'class' => 'form-control'])}}
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="field-5">{{config('aggregator.purpose')}} Price</label>
                        <span class="desc"></span>
                        {{ Form::text('item_price', null, ['placeholder' => 'Item Price','class' => 'form-control']) }}
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="field-5">{{config('aggregator.purpose')}} Quantity</label>
                        <span class="desc"></span>
                        {{ Form::text('item_quantity', null, ['placeholder' => 'Item quantity','class' => 'form-control']) }}
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="field-5">{{config('aggregator.purpose')}} Quantity Unit</label>
                        <span class="desc"></span>
                        {{Form::select('item_quantity_unit', ['hour' => 'Hour', 'tonne' => 'Tonne', 'litter'=>'Litter', 'no_unit'=>'No Unit'], null, ['placeholder' => 'Select Item Quantity Unit', 'class' => 'form-control'])}}
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="field-5">{{config('aggregator.purpose')}} Status</label>
                        <span class="desc"></span>
                        {{Form::select('item_status', ['draft' => 'Draft', 'published' => 'Published', 'review'=>'Review', 'inactive'=>'Inactive'], null, ['placeholder' => 'Select Status', 'class' => 'form-control'])}}
                    </div>
                    {{--<div class="form-group">
