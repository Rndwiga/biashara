...
<html lang="en">
  <head>
    ...
    @include(config('biashara.views.v1.partials.meta'))
    <!-- Bootstrap -->
    <link href="{{asset('vendor/tyondo/biashara/admin/vendor/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="{{asset('vendor/tyondo/biashara/admin/vendor/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
    <!-- NProgress -->
    <link href="{{asset('vendor/tyondo/biashara/admin/vendor/nprogress/nprogress.css')}}" rel="stylesheet">
    <!-- iCheck -->
    <link href="{{asset('vendor/tyondo/biashara/admin/vendor/iCheck/skins/flat/green.css')}}" rel="stylesheet">
    <!-- Datatables -->
    <link href="{{asset('vendor/tyondo/biashara/admin/vendor/DataTables/datatables.min.css')}}" rel="stylesheet">

  @yield('css')
    <!-- Custom Theme Style -->
    <link href="{{asset('vendor/tyondo/biashara/admin/vendor/custom/css/custom.min.css')}}" rel="stylesheet">
  </head>
  @if(isset($noroot)
        )
    <body class="login">
  ...
  <body class="nav-md">
    ...
    <!-- jQuery -->
    <script src="{{asset('vendor/tyondo/biashara/admin/vendor/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{asset('vendor/tyondo/biashara/admin/vendor/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <!-- FastClick -->
    <script src="{{asset('vendor/tyondo/biashara/admin/vendor/fastclick/lib/fastclick.js')}}"></script>
    <!-- NProgress -->
    <script src="{{asset('vendor/tyondo/biashara/admin/vendor/nprogress/nprogress.js')}}"></script>
    <!-- iCheck -->
    <script src="{{asset('vendor/tyondo/biashara/admin/vendor/iCheck/icheck.min.js')}}"></script>
    <!-- Datatables -->
    <script src="{{asset('vendor/tyondo/biashara/admin/vendor/DataTables/datatables.min.js')}}"></script>

    <!-- Custom Theme Scripts -->
    <script src="{{asset('vendor/tyondo/biashara/admin/vendor/custom/js/custom.min.js')}}"></script>
    @yield('script')
    ...
    <!-- /Datatables -->
    @if (isset($ga))
        {{--!empty(\Tyondo\Aggregator\Models\Settings::gaId())--}}
        @include(config('biashara.views.v1.partials.gAnalytics'))
    @endif
  </body>
    @endif
</html>
